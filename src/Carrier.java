public class Carrier extends Ship {
    ...
    void placeShip(char[][] gameBoard, int size, char symbol, String shipCoordinate, char vertHor) {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            //if horizontalPlacement > 5
            if (horizontalPlacement > 5 && Character.getNumericValue(shipCoordinate.charAt(1)) > 5 &&  vertHor == 'h' || vertHor == 'H') {
//                System.out.println("Not a valid placement!");
                ...
                switch (shipCoordinate.charAt(0)) {
                    ...
                    case 'a', 'A':
                        ...
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[1][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                                } else if (gameBoard[1][horizontalPlacement] == '~' && gameBoard[1][horizontalPlacement] != 'b' ){
                                    placed = true;
                                    gameBoard[1][horizontalPlacement] = symbol;
                                }
                            }
                            case 'v', 'V' -> {
                                if (gameBoard[i][Character.getNumericValue(shipCoordinate.charAt(1))] == 'b') {
                                    placed = false;
                                    break outer;
                                } else if (gameBoard[i][Character.getNumericValue(shipCoordinate.charAt(1))] == '~' && gameBoard[i][Character.getNumericValue(shipCoordinate.charAt(1))] != 'b'){
                                    placed = true;
                    ...
                    case 'b', 'B':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[2][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                                } else if (gameBoard[2][horizontalPlacement] == '~' && gameBoard[2][horizontalPlacement] != 'b' ) {
                                    placed = true;
                                    gameBoard[2][horizontalPlacement] = symbol;
                                }
                            }
                            case 'v', 'V' -> {
                                if (gameBoard[1 + i][Character.getNumericValue(shipCoordinate.charAt(1))] == 'b') {
                                    placed = false;
                                    break outer;
                                } else if (gameBoard[1 + i][Character.getNumericValue(shipCoordinate.charAt(1))] == '~' && gameBoard[1 + i][Character.getNumericValue(shipCoordinate.charAt(1))] != 'b') {
                                    placed = true;
                    ...
                    case 'c', 'C':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[3][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                            ...
                            case 'v', 'V' -> {
                                if (gameBoard[2 + i][Character.getNumericValue(shipCoordinate.charAt(1))] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'd', 'D':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[4][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                            ...
                            case 'v', 'V' -> {
                                if (gameBoard[3 + i][Character.getNumericValue(shipCoordinate.charAt(1))] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'e', 'E':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[5][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                            ...
                            case 'v', 'V' -> {
                                if (gameBoard[4 + i][Character.getNumericValue(shipCoordinate.charAt(1))] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'f', 'F':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[6][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'g', 'G':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[7][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'h', 'H':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[8][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
                    ...
                    case 'i', 'I':
                        switch (vertHor) {
                            case 'h', 'H' -> {
                                if (gameBoard[9][horizontalPlacement] == 'b') {
                                    placed = false;
                                    break outer;
